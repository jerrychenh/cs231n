...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out, afre_cache = affine_relu_forward(out, W2, b2)
        scores, affind_cache = affine_forward(out, W3, b3)
        ...
        dout, dW3, db3 = affine_backward(dout, affind_cache)
        dW3 += self.reg * W3
        dout, dW2, db2 = affine_relu_backward(dout, afre_cache)
        dW2 += self.reg * W2
